...
DiLeptonDiJetTagCandidate::DiLeptonDiJetTagCandidate(): tag_(0) {
    // vbfMVA_            = -9999.;
    // combindedMVA_      = -9999.;
    // dijet_leadEta_     = -9999.;
...
DiLeptonDiJetTagCandidate::~DiLeptonDiJetTagCandidate() 
{}

DiLeptonDiJetTagCandidate::DiLeptonDiJetTagCandidate( const flashgg::DiLeptonDiJetTagBase* tag ): tag_(tag) { //, int triggerBits[3] ): tag_(tag) {
    cat_ = 2; 
