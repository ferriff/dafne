#ifndef FLASHgg_BaseSystMethod_DiLeptonDiJet_h
#define FLASHgg_BaseSystMethod_DiLeptonDiJet_h
...
typedef FlashggSystematicMethodsFactory<flashgg::DiLeptonDiJetCandidate, int> FlashggSystematicDiLeptonDiJetMethodsFactory;
typedef FlashggSystematicMethodsFactory<flashgg::DiLeptonDiJetCandidate, std::pair<int, int> > FlashggSystematicDiLeptonDiJetMethodsFactory2D;
