...
#         process.flashggDiLeptonDiJetSystematics.SystMethods.insert(0, isyst)

#     # add EGM smearings (2D)
#     process.flashggDiLeptonDiJetSystematics.SystMethods2D.extend([
...
def customizeElectronSystematicsForData(process):
	...
	for pset in process.flashggDiLeptonDiJetSystematics.SystMethods:
...
def customizeElectronSystematicsForMC(process):
	...
	for pset in process.flashggDiLeptonDiJetSystematics.SystMethods2D:
		pset.ApplyCentralValue = cms.bool(True)  # Turn on central shift 
