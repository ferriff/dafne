...
if (electronsNotRandomized):
    process.flashggDiLeptonDiJetSystematics.src = "flashggRandomizedElectronForDiLeptonDiJets"
...
if customize.processType == "data":
	...
	process.p = cms.Path(process.hltHighLevel*
					...
					process.flashggRandomizedElectronForDiLeptonDiJets*
					process.flashggDiLeptonDiJetSystematics*
